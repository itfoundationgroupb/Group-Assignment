...
public class CarpetCode {
	   ...
	   public static void main(String[] args) {
		...
		// This is the declaration of the variables in the program.
		...
		//This is where you enter which of the five carpets you wish to use. Whenever you have selected your carpet choice, You enter 0. This is due to the code being a loop incase the user wants to order more than one carpet.
		opt = key.nextInt();
		...
		//This is where the price for the carpet will be displayed.
		break;
		...
		}}if (noItems != 0)
		{
		 ...
		 length = key.nextInt();
		 //This is the section where you have to enter the length of the carpet. it is preferable that you enter this value in whole numbers due to length being an integer.  
		 ...
		 System.out.print("\n\tThe price for your carpet size is:" + PricewithLength);
		    //This is where the price for your carpet with the additional length cost will be.
		...
		opt = key.nextInt();
		//This is where the user will enter the extra they wish to have alongside their ordered carpet.This will add the extra cost to the current price.
	    ...
	    //This is where the code will display the final cost of your order.
		}
		}
